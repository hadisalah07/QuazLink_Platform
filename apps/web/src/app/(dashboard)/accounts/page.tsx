...
const PLATFORMS: PlatformConfig[] = [
  ...
  },
  {
    ...
    bgGradient: "from-emerald-600/20 via-teal-900/15 to-green-600/10",
    borderClass: "border-emerald-500/30",
    description: "Publish WhatsApp Status stories, catalog announcements, and direct client messaging.",
  },
  {
    id: "tiktok",
    name: "TikTok",
...
function AccountCard({
  ...
  const isWa = account.platform.toLowerCase() === "whatsapp";

  const PlatformIcon = isIg ? InstagramIcon : isTt ? TikTokIcon : isWa ? WhatsAppIcon : FacebookIcon;
